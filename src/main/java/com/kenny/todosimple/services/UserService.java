...
public class UserService {
  ...
  public User findById(Long id) {
    ...
    return user
        .orElseThrow(() -> new RuntimeException("Usuario nao encontrado! " + id + ", Tipo:" + User.class.getName()));
  }
  ...
  public void delete(Long id) {
    ...
    try {
      ...
      throw new RuntimeException("Nao é possivel excluir pos há entidades (Task) relacionada");
    }
  }
}
